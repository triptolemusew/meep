...
class TodoItem extends Component {
  ...
  render() {
    ...
    return (
      <li className={todoClass} onClick={this._onClickTodo.bind(this)}>
        <section className="left">
          {updating ? (
            <BounceLoader className="loading" color="#fac801" size="18px" />
          ) : (
            <input
              type="checkbox"
              checked={completed}
        ...
        {deleting ? (
          <BounceLoader className="loading" color="#fc635d" size="18px" />
        ) : (
          <div className="delete-icon" onClick={this._onClickDelete.bind(this)}>
